...
function createMap(){
    ...
    var apitoken = 'pk.eyJ1IjoidG95ZWVubGF3YWwiLCJhIjoiY2xiZWx3OGM0MGNtcDNycGFiNGtkYWI4MyJ9.Bt3qhKOceiejRkUGTIqBqw' //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
    ...
    var darkTerrain = L.tileLayer(mbStyleUrl, {id: 'toyeenlawal/clbekspiz000314mpq55dvban', token: apitoken,  attribution: mbAttr});
